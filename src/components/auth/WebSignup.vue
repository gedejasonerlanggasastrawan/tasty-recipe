...
<template>
    <div class="container-fluid py-5" style="background-color: #f5f5f5">
      <div style="background-color: #ffffff" class="p-5 m-auto signup-form">
        ...
        <form class="mt-3" @submit.prevent="register">
          <div class="row">
            ...
            <div class="col-md-6"> 
              ...
              identity="firstname" 
              placeholder="Ex: Jack" 
              label="Firstname" v-model="signupData.firstname"></base-input> 
            </div>
            ...
            <div class="col-md-6">
              ...
              label="Lastname" v-model="signupData.lastname"></base-input> 
          ...
          <div class="my-4">
            <base-input type="text" 
              ...
              label="Username" v-model="signupData.username"></base-input> 
          </div>
          ...
          <div class="my-4">
            ...
            <p class="text-danger mt-1 fw-medium" style="font-size: 11px" 
              ...
              The password field must be at least 8 characters </p>
          </div>
          ...
          <div class="my-4">
            <base-input type="password" 
              ...
              </p> <p class="text-success mt-1 fw-medium" style="font-size: 11px"
              :style="{ display: confirmationPasswordMatch }"> 
                The password confirmation does match </p> 
          </div>
          <div class="my-4">
        ...
        <base-button
        class="login w-100 my-3">Register
      </base-button>
        
        </form>
        <div class="text-center mt-4">
          <p class="fw-semibold">
            Already have account?<router-link to="/login" style="color: #4c4ddc"
              ><a class="text-decoration-none"> Login</a></router-link>
          </p>
        </div>
      </div>
    </div>
