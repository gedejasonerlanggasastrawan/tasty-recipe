...
<template>
  <div class="container-md my-5 py-5">
      <div class="recipe__title text-center">
          <h2>All Recipe</h2>
          <p style="font-size: 15px">Find and share everyday cooking inspiration on Allrecipes. Discovery recipes, cooks, videos, and how_tos based on the food you love and the friends you follow</p>
      </div>
